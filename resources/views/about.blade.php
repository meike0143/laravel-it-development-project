        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="font-semibold text-l text-gray-800 leading-tight">Welcome to Our App</h3>
                    <p>
                    ...
                    <br>
                    <h3 class="font-semibold text-l text-gray-800 leading-tight">Key Features</h3>
                    <p>
                    ...
                    <br>
                    <h3 class="font-semibold text-l text-gray-800 leading-tight">Our Vision</h3>
                    <p>
